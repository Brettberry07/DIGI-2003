 ...
 */
var runningChallenges: [String] = ["Run a sub 6 minutes mile","Run a marathon","Run half a marathon"]
var walkingChallenges: [String] = ["Go on a hike", "Walk for 5 miles", "Walk everyday for a week"]
...
var challenges: [Array] = [runningChallenges, walkingChallenges]
...
var commitedChallenges: [String] = ["Run half a marathon"]
...
if(commitedChallenges.isEmpty){
    ...
    print("You have chosen mutiple challenges")
}
