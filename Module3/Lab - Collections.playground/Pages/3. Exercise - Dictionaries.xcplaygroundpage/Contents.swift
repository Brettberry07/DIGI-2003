 ...
 */
var calendar: [String: Int] = ["January":31, "Febuary":28, "March":31]
...
calendar.updateValue(29, forKey: "Febuary")
print(calendar)

//:  Use if-let syntax to retrieve the number of days under "January." If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
if let januaryValue = calendar["January"]{
    print("January has \(januaryValue) days")
}
...
print(newDict["Colors"]?.last as Any)
