...
let somePlace: GPS = GPS(latitude: 51.514004, longitude: 0.125226)
...
let favoriteBook: Book = Book(title: "Scythe", author: "Neal Shusterman", pages: 464, price: 16.61)
print("""
...
struct Laptop{
    ...
    var repairCount: Int = Int()
    var yearPurchased: Int
}

let laptopOne: Laptop = Laptop(yearPurchased: 2020)
let laptopTwo: Laptop = Laptop(screenSize: 15, repairCount: 1, yearPurchased: 2024)
 ...
 */
struct Height{
    var heightInInches: Double = Double()
    var heightInCentimeters: Double = Double()
...
var someonesHeight: Height = Height(heightInInches: 65)
...
var myHeight: Height = Height(heightInInches: 69)
