...
let me: User = User(name: "Brett", height: 69, weight: 125, activityLevel: 7)
print("My name is \(me.name), I weigh \(me.weight) lbs, I am \(me.height) in. tall, and I am fairly active with an activity level of \(me.activityLevel)")
...
let mile: Distance = Distance(meters: 1600)
print(mile.feet)

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let yard: Distance = Distance(feet: 3)
print(yard.meters)
