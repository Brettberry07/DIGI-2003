...
struct User {
    ...
    static var currentUser: User = User(userName: "brettberry", email: "brettberry@gmail.com", age: 16)
    static func logIn(user: User){
        print("\(user.userName) you have successfully logged in!")
    }
    
}

var myUser: User = User(userName: "John Doe", email: "JohnDoe@gmai.com", age: 21)
print("The current User's username is \(User.currentUser.userName), thei email is \(User.currentUser.email), and they are \(User.currentUser.age) years old.")
/*:
 ...
 */
User.logIn(user: User(userName: "blah_blah", email: "blahblah@email.com", age: 32))
