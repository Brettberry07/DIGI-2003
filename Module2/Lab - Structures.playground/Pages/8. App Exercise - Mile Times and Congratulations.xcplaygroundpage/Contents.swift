...
let workout: RunningWorkout = RunningWorkout(distance: 3200, time: 20, elevation: 65)
print("Your average mile time is: \(workout.averageMileTime) minutes.")
/*:
...
struct Steps {
    var steps: Int{
        willSet{
            if(newValue==goal){
                print("Congrats you made it to yuor goal!")
            }
        }
    }
    var goal: Int
...
var walker: Steps = Steps(steps: 9999, goal: 10000)
walker.steps+=1
