...
progressUpdate(steps: 5403, goal: 8000)
progressUpdate(steps: 354, goal: 10000)
progressUpdate(steps: 2800, goal: 2500)
progressUpdate(steps: 2300, goal: 5000)

//:  Your fitness tracking app is going to help runners stay on pace to reach their goals. Write a function called pacing that takes four `Double` parameters called `currentDistance`, `totalDistance`, `currentTime`, and `goalTime`. Your function should calculate whether or not the user is on pace to hit or beat `goalTime`. If yes, print "Keep it up!", otherwise print "You've got to push it just a bit harder!"
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double)->Void{
    //Time is represented by 4:50 = 4.50
    
    var avgPace: Double = currentTime / currentDistance
    var goalPace: Double = goalTime/totalDistance
...
pacing(currentDistance: 2.3, totalDistance: 5, currentTime: 20.56, goalTime: 30.00)
pacing(currentDistance: 5, totalDistance: 10, currentTime: 4.45, goalTime: 12.00)
