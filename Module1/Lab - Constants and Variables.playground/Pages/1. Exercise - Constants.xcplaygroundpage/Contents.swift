...
print("The above code does not compile because the let keyword creates a constant")
print("Constants are not mutable, there they cannot change, if you wanted to change it you would use var")
