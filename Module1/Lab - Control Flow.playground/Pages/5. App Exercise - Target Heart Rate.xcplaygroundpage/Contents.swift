...
let isInTarget: Bool = currentHR >= 120 && currentHR <= 150
let isBelowTarget: Bool = currentHR<120
let isAboveTarget: Bool = currentHR>150

if(isBelowTarget){
    print("You're doing great, but try to oush it a bit!")
}
else if(isInTarget){
