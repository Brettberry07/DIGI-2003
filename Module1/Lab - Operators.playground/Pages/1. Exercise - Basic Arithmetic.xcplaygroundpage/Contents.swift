...
let perimeter: Int = (width*2)+(height*2)
print(perimeter)
...
let divisionResult: Double = 10/3
print(divisionResult)
print("This differs from the integer value because it has decimal places. Integer's always round down to the whole number.")
/*:
...
print(even%2)
print(odd%2)
print("We can tell if any number is even or odd simply by seeing if num%2 is equal to 0(even) or 1(odd)")
