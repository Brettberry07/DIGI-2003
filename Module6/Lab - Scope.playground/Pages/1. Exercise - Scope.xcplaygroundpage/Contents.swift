...
//This is because this is outside of the constant foo's scope, best way to tell is it is outside the brackets it was declared in
...
//These both compile because the variable x is a constant decalred outside of a bracket scope menaing it can be accessed everywhere, and in the for loop we are accessing the global variable by 1, 10 times.
...
greeting(greeting: nil, name: "Brett")
